...
const mock = [
    {
        ...
        description: 'Find adventures nearby or in faraway places and access unique homes, experiences, and places around the world.',
    },
    {
    ...
    },
    {
        ...
        description: "Search the world's information. Google has many special features to help you find exactly what you're looking for.",
    },
    {
            ...
            <Slider {...sliderOpts}>
                {mock.map((item, i) => (
                    <Box key={i} padding={{ xs: 1, sm: 2, md: 3 }}>
                        ...
                        >
                            <Box component={Card} width={1} height={1} borderRadius={2} display={'flex'} flexDirection={'column'}>
