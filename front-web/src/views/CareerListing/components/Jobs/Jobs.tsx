...
const Jobs = (): JSX.Element => {
    ...
    return (
        <Box>
            <Box marginBottom={4}>
                <Typography align={'center'} color={'text.secondary'} sx={{ textTransform: 'uppercase' }} variant={'subtitle2'} fontWeight={600}>
                    Open positions
                </Typography>
            ...
            >
                ...
                <Grid item xs={12} md={4}>
                    <FormControl variant="outlined" sx={{ minWidth: 1 }}>
                        <InputLabel id="career-listing__jobs-role--label">Locations</InputLabel>
            ...
            >
                <Box marginBottom={{ xs: 1, sm: 0 }}>
                    ...
                    <Typography color={'text.secondary'}>User experience and design are top priorities at theFront.</Typography>
                </Box>
