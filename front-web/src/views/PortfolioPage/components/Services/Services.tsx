...
const mock = [
    {
        ...
        icon: (
            <svg width={42} height={42} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                    strokeLinecap="round"
    ...
    return (
        <Box>
            <Box marginBottom={4}>
                ...
                <Typography fontWeight={700} variant={'h4'} align={'center'} gutterBottom data-aos={'fade-up'}>
