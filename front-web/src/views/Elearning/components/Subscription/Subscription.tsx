            ...
            <Box component={Card} boxShadow={4} paddingY={3}>
                <CardContent>
                    <Box display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
                        <Box marginBottom={4}>
                            <Typography variant="h4" align={'center'} data-aos={'fade-up'} gutterBottom sx={{ fontWeight: 700 }}>
                        ...
                        >
                            <FormControl fullWidth variant="outlined" sx={{ maxWidth: { xs: 1, sm: 400 }, width: 1 }}>
