    ...
    return (
        <Grid container spacing={4}>
            ...
            <Grid item container spacing={2} xs={12} md={6}>
                {mock.map((item, i) => (
                    <Grid item xs={4} key={i} data-aos="fade-up" data-aos-delay={i * 100} data-aos-offset={100} data-aos-duration={600}>
                        <Box
                            display={'block'}
                            width={1}
                            height={1}
                        ...
                        >
                            <Card>
                                ...
                                >
                                    <Box component={'img'} loading="lazy" height={50} width={50} src={item.logo} alt={item.name} />
                                </CardContent>
                            </Card>
                        </Box>
                    </Grid>
