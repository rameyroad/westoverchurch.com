        ...
        <Box>
            <Box marginBottom={4}>
                ...
                <Typography variant="h6" align={'center'} color={'text.secondary'} data-aos={'fade-up'}>
                    ...
                    <br />
                    Discover coworking spaces designed to inspire and to connect you to a community of motivated people.
                </Typography>
            ...
            <Box>
                <ImageList variant="quilted" cols={3} rowHeight={isMd ? 300 : 220} gap={isMd ? 16 : 8}>
                    {photosToShow.map((item, i) => (
                        <ImageListItem key={i} cols={isMd ? item.cols || 1 : 3} rows={isMd ? item.rows || 1 : 1}>
                            <img
                                height={'100%'}
                                width={'100%'}
                                src={item.src}
