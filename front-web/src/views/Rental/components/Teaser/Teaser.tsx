    ...
    return (
        <Box>
            <Grid container spacing={4} direction={isMd ? 'row' : 'column'}>
                <Grid item container alignItems={'center'} xs={12} md={6} data-aos={isMd ? 'fade-right' : 'fade-up'}>
                    <Box>
                        <Typography
                            sx={{
                ...
                <Grid item container justifyContent="center" alignItems="center" xs={12} md={6}>
                    <Box maxWidth={490} width={1}>
                        <Box
                            component={'img'}
                            src={'https://assets.maccarianagency.com/svg/illustrations/drawkit-illustration5.svg'}
                            width={1}
                            height={1}
                            sx={{
