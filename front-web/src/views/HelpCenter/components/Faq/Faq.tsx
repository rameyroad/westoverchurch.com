        ...
        <Box>
            <Grid container spacing={4}>
                <Grid item xs={12} md={6}>
                    <Box marginBottom={2}>
                        <Box component={Avatar} bgcolor={colors.amber[100]} color={colors.amber[900]} marginBottom={1} width={60} height={60}>
                        ...
                        <Typography color={'text.secondary'}>{mock.account.subtitle}</Typography>
                    </Box>
                ...
                <Grid item xs={12} md={6}>
                    <Box marginBottom={2}>
                        <Box component={Avatar} bgcolor={colors.green[100]} color={colors.green[900]} marginBottom={1} width={60} height={60}>
                            <Box component={'svg'} fill="none" viewBox="0 0 24 24" stroke="currentColor" width={24} height={24}>
                                <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                        ...
                        <Typography color={'text.secondary'}>{mock.billing.subtitle}</Typography>
                    </Box>
                    <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6} sx={{ marginTop: 2 }}>
                    <Box marginBottom={2}>
                        <Box component={Avatar} bgcolor={colors.red[100]} color={colors.red[900]} marginBottom={1} width={60} height={60}>
                            <Box component={'svg'} fill="none" viewBox="0 0 24 24" stroke="currentColor" width={24} height={24}>
                                <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                        ...
                        <Typography color={'text.secondary'}>{mock.organizations.subtitle}</Typography>
                    </Box>
                    <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6} sx={{ marginTop: 2 }}>
                    <Box marginBottom={2}>
                        <Box component={Avatar} bgcolor={colors.blue[100]} color={colors.blue[900]} marginBottom={1} width={60} height={60}>
                            <Box component={'svg'} fill="none" viewBox="0 0 24 24" stroke="currentColor" width={24} height={24}>
                                <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                        ...
                        <Typography color={'text.secondary'}>{mock.customizing.subtitle}</Typography>
                    </Box>
                    <Grid container spacing={2}>
