...
const Overview = (): JSX.Element => {
    return (
        <Box bgcolor={'primary.main'} borderRadius={2} paddingBottom={{ xs: 2, md: 0 }}>
            <Grid container data-aos="fade-up">
                ...
                >
                    <Box marginBottom={2}>
                        <Typography variant="h4" color="text.primary" align={'center'} sx={{ fontWeight: 700, color: 'common.white' }}>
                            Fide more products
                        </Typography>
