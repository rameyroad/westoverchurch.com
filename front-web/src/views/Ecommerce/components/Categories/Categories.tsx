...
const mock = [
    {
        title: 'Headphones',
        icon: (
            <svg height={48} width={48} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path
                    fillRule="evenodd"
                        ...
                        <Grid item xs={6} md={2} key={i}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Typography variant={'subtitle1'} align={'center'} sx={{ fontWeight: 500, marginTop: 2 }}>
                                        {item.title}
                                    </Typography>
                                </Box>
                            </Box>
