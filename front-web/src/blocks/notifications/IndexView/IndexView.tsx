            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Use notifications to inform a users about specific events.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/notifications/WithActionButtons/WithActionButtons.js|ts'}
                    iframeStyles={{ minHeight: 204 }}
                />
                <ResizableFrame
                    src={'/blocks/notifications/with-avatar-and-buttons-below'}
                    title={'With avatar and buttons below'}
                    path={'./src/blocks/notifications/WithAvatarAndButtonsBelow/WithAvatarAndButtonsBelow.js|ts'}
                    iframeStyles={{ minHeight: 204 }}
                />
                <ResizableFrame
                    src={'/blocks/notifications/with-split-buttons'}
                    title={'With split buttons'}
                    path={'./src/blocks/notifications/WithSplitButtons/WithSplitButtons.js|ts'}
                    iframeStyles={{ minHeight: 204 }}
                />
            </Box>
        </Fluid>
