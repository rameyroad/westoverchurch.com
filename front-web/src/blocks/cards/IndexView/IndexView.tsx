            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to display information to users, with button to trigger actions.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/cards/card-with-color-accent'}
                    title={'Card with color accent'}
                    path={'./src/blocks/cards/CardWithColorAccent/CardWithColorAccent.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/cards/card-with-checkboxes'}
                    title={'Card with checkboxes'}
                    path={'./src/blocks/cards/CardWithCheckboxes/CardWithCheckboxes.js|ts'}
                />
                <ResizableFrame
