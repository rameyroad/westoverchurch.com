            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Collect payment information and delivery information to complete orders.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/checkout-pages/with-two-columns'}
                    title={'Checkout page with two columns'}
                    path={'./src/blocks/checkoutPages/WithTwoColumns/WithTwoColumns.js|ts'}
                />
            </Box>
        </Fluid>
    );
