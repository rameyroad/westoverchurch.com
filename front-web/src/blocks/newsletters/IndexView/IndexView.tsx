            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Get your visitors and followers to subscribe or signup to your mailing list.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/newsletters/newsletter-with-card'}
                    title={'Newsletter section with card'}
                    path={'./src/blocks/newsletters/NewsletterWithCard/NewsletterWithCard.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/newsletters/newsletter-with-image'}
                    title={'Newsletter section with image'}
                    path={'./src/blocks/newsletters/NewsletterWithImage/NewsletterWithImage.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/newsletters/with-dark-background'}
                    title={'With dark background'}
                    path={'./src/blocks/newsletters/WithDarkBackground/WithDarkBackground.js|ts'}
                />
            </Box>
        </Fluid>
    );
