                ...
                <Grid item xs={12} md={6}>
                    <Box marginBottom={4}>
                        ...
                        <Typography variant={'h6'} component={'p'} color={'text.secondary'}>
                            Whether you're creating a subscription service, an on-demand marketplace, an e-commerce store, or a portfolio showcase,
                            theFront helps you create the best possible product for your users.
                        </Typography>
                    </Box>
