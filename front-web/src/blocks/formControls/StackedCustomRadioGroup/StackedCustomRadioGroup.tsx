        ...
        <Box bgcolor={'alternate.main'}>
            <Container maxWidth={800}>
                ...
                <FormControl component="fieldset" sx={{ width: 1 }}>
                    <RadioGroup defaultValue="2" name="radio-buttons-group" sx={{ width: 1 }}>
                        {mock.map((item, i) => (
                            <Card key={i} sx={{ width: 1, paddingX: { xs: 1, sm: 2 }, marginY: 1 }}>
                                <FormControlLabel
                                    value={item.value}
                                    control={<Radio />}
                                    label={
                                        ...
                                        >
                                            ...
                                            <Box>
                                                ...
                                                <Typography color={'text.secondary'} variant={'caption'} align={'right'} component={'p'}>
                                                    {item.priceSuffix}
                                                </Typography>
                                            </Box>
                                        </Box>
