            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Rave about customer testimonials of your services and products.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/testimonials/with-highlighted-card'}
                    title={'With highlited card'}
                    path={'./src/blocks/team/WithHighlightedCard/WithHighlightedCard.js|ts'}
                />
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/team/ReviewsWithBorderedGridLayout/ReviewsWithBorderedGridLayout.js|ts'}
                />
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/team/ReviewsWithSimpleBoxes/ReviewsWithSimpleBoxes.js|ts'}
                />
                <ResizableFrame
