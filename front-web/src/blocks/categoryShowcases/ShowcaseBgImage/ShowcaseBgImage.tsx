...
const ShowcaseBgImage = (): JSX.Element => {
    ...
    return (
        ...
        >
            <Container display={'flex'} justifyContent={{ xs: 'center', sm: 'flex-end' }}>
                <Card
                    sx={{
                        width: 1,
                        maxWidth: { xs: 1, sm: '50%' },
                ...
                >
                    ...
                    <Link href={mock.href} color={'text.primary'} variant={'h5'} fontWeight={700} sx={{ marginTop: 4, display: 'block' }}>
                        Discover more
                    </Link>
                </Card>
            </Container>
