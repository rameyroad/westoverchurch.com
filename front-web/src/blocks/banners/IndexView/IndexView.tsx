            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to display an important message at the top or bottom of the page.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/banners/MUIStandardSnackBars/MUIStandardSnackBars.js|ts'}
                />
            </Box>
        </Fluid>
    );
