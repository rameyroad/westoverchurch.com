            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to display products added to the store shopping cart.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/shopping-carts/cart-with-order-summery'}
                    title={'Cart with order summary box'}
                    path={'./src/blocks/shoppingCarts/CartWithOrderSummery/CartWithOrderSummery.js|ts'}
                />
                <ResizableFrame
