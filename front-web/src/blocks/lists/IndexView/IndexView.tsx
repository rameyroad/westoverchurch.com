            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Lists are a simple ways to displays related data.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/lists/ListWithNestedItem/ListWithNestedItem.js|ts'}
                    iframeStyles={{ minHeight: 328 }}
                />
                <ResizableFrame
                    src={'/blocks/lists/list-with-vertical-line'}
                    title={'List with vertical line'}
                    path={'./src/blocks/lists/ListWithVerticalLine/ListWithVerticalLine.js|ts'}
                />
            </Box>
        </Fluid>
    );
