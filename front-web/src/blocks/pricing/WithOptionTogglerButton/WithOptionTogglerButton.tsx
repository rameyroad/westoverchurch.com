...
const mock = [
    ...
    },
    {
        ...
        features: ['All in Starter plan', 'Google Ads', 'SSO via Google', 'API access'],
        isHighlighted: true,
    },
    {
        title: 'Enterprise',
        ...
        features: ['All features', 'Email support', 'Google Ads', 'SSO via Google', 'API access', 'Facebook Ads'],
        isHighlighted: false,
    },
];
            ...
            <ToggleButtonGroup value={pricingOption} exclusive onChange={handleClick}>
                ...
                >
                    <Typography
                        ...
                        sx={{
                            fontWeight: 700,
                            color: pricingOption === 'annual' ? 'common.white' : 'text.primary',
                        }}
                    >
                        Annual
                    </Typography>
                                ...
                                >
                                    ...
                                    <Box display={'flex'} alignItems={'baseline'} marginBottom={2}>
                                        <Typography variant={'h3'} fontWeight={700}>
                                            {pricingOption === 'annual' ? item.price.annual : item.price.monthly}
                                        </Typography>
