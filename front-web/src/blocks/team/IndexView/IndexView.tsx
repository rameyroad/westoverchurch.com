            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to showcase your team, give your brand a face and gain customers' trust.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/team/team-with-circled-photos'}
                    title={'Team with circled photos'}
                    path={'./src/blocks/team/TeamWithCircledPhotos/TeamWithCircledPhotos.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/team/with-overlapped-cards'}
                    title={'Team boxes with overlapped card'}
                    path={'./src/blocks/team/WithOverlappedCards/WithOverlappedCards.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/team/with-large-images-and-social-icons'}
                    title={'Team card with large photos and social media icons & links'}
                    path={'./src/blocks/team/WithLargeImagesAndSocialIcons/WithLargeImagesAndSocialIcons.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/team/team-with-small-square-photos'}
                    title={'Team with small square photos'}
                    path={'./src/blocks/team/TeamWithSmallSquarePhotos/TeamWithSmallSquarePhotos.js|ts'}
                />
                <ResizableFrame
