            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to display a prominent call-to-action that converts leads to customers.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/cta/CtaAlignedLeftWithTypedText/CtaAlignedLeftWithTypedText.js|ts'}
                    iframeStyles={{ minHeight: 362 }}
                />
                <ResizableFrame
                    src={'/blocks/cta/cta-with-right-buttons'}
                    title={'CTA with right buttons'}
                    path={'./src/blocks/cta/CtaWithRightButtons/CtaWithRightButtons.js|ts'}
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/cta/CtaWithRightDownloadButton/CtaWithRightDownloadButton.js|ts'}
