            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to quickly explore a product's detail within a modal dialog.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/product-quick-views/popup-box-with-product-details'}
                    title={'Popup box with product details'}
                    path={'./src/blocks/productQuickViews/PopupBoxWithProductDetails/PopupBoxWithProductDetails.js|ts'}
