    ...
    return (
        <Grid container spacing={4}>
            <Grid item xs={6}>
                ...
                {['Men’s fashion', 'New arrivals', 'Clothing', 'Footwear', 'Watches', 'Jewellry', 'Backpacks', 'Luggage'].map((i) => (
                    <Link key={i} href={'#'} underline={'hover'} color={'text.primary'} sx={{ display: 'block', marginTop: 1, whiteSpace: 'nowrap' }}>
                        {i}
                    </Link>
                ))}
            </Grid>
            <Grid item xs={6}>
                ...
                {['Nike', 'Tommy Hilfiger', 'Skechers', 'Converse', 'Puma', 'Adidas', 'Under Armour', 'Jack & Jones'].map((i) => (
                    <Link key={i} href={'#'} underline={'hover'} color={'text.primary'} sx={{ display: 'block', marginTop: 1, whiteSpace: 'nowrap' }}>
                        {i}
                    </Link>
                ))}
