            ...
            <Box display={'flex'} justifyContent={'center'}>
                ...
                >
                    <Stack spacing={2} maxWidth={460}>
                        ...
                        >
                            {mock.map((item, i) => (
                                <ListItem key={i} component={Link} href={'#'} alignItems={'flex-start'}>
                        ...
                        <Stack direction={'column'} spacing={1} padding={2} bgcolor={'alternate.main'}>
                            <Typography color={'text.secondary'} marginBottom={1} sx={{ textTransform: 'uppercase' }}>
                                Recent posts
                            </Typography>
