                                ...
                                <CardContent>
                                    <form noValidate autoComplete="off">
                                        <Grid container spacing={2}>
                                            <Grid item xs={12}>
                                                <TextField label="Full name" name="fullName" fullWidth type="text" />
                                            </Grid>
                                            <Grid item xs={12}>
                                                <TextField label="Email" name="email" fullWidth type="email" />
                                            </Grid>
                                            <Grid item xs={12}>
                        ...
                        <Box>
                            <Box marginBottom={2}>
                                ...
                                <Typography color="text.secondary">
                                    Using theFront to build your site means never worrying about designing another page or cross browser
                                    compatibility. Our ever-growing library of components and pre-designed layouts will make your life easier.
                                </Typography>
                            </Box>
                            <Grid container spacing={1}>
                                {['All features', 'Email support', 'Lifetime updates', 'Tons of assets', 'Tech support', 'Integration ready'].map(
                                    (item, i) => (
