...
const mock = [
    {
        title: 'High quality',
        subtitle: 'We will always give you the opportunity to get acquainted with the instrument closer.',
    },
    {
    ...
    },
    {
        ...
        subtitle: 'You will always get professional advice on the selection of musical instruments, equipment and accessories.',
    },
];
                ...
                <Grid container spacing={2}>
                    {mock.map((item, i) => (
                        <Grid item xs={12} sm={4} key={i}>
                            ...
                            >
                                <Box component={Card} width={1} height={1} display={'flex'} flexDirection={'column'} bgcolor={'alternate.main'}>
                                    <CardContent>
