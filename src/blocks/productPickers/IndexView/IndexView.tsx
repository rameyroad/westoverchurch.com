            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Common eCommerce product controls like color picker, size picker, etc.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/productPickers/QuantityPicker/QuantityPicker.js|ts'}
                    iframeStyles={{ minHeight: 134 }}
                />
                <ResizableFrame
