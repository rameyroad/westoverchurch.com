            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Provides common application layout shells to get your app up and running in no time.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/page-layouts/with-fixed-sidebar'}
                    title={'With fixed sidebar'}
                    path={'./src/blocks/pageLayouts/WithFixedSidebar/WithFixedSidebar.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/page-layouts/with-three-columns'}
                    title={'Shell with three columns'}
                    path={'./src/blocks/pageLayouts/WithThreeColumns/WithThreeColumns.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/page-layouts/with-toggled-sidebar'}
                    title={'With toggled sidebar'}
                    path={'./src/blocks/pageLayouts/WithToggledSidebar/WithToggledSidebar.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/page-layouts/with-fluid-layout-and-no-sidebar'}
                    title={'With fluid layout and without sidebar'}
                    path={'./src/blocks/pageLayouts/WithFluidLayoutAndNoSidebar/WithFluidLayoutAndNoSidebar.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/page-layouts/with-narrow-layout-and-no-sidebar'}
                    title={'With narrow layout and without sidebar'}
                    path={'./src/blocks/pageLayouts/WithNarrowLayoutAndNoSidebar/WithNarrowLayoutAndNoSidebar.js|ts'}
                />
            </Box>
        </Fluid>
    );
