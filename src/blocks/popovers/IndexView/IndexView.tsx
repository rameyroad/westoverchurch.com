            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>A Popover can be used to display some content on top of another.</Typography>
                    </Box>
                </Container>
                <ResizableFrame src={'/blocks/popovers/simple'} title={'Simple'} path={'./src/blocks/popovers/Simple/Simple.js|ts'} />
                <ResizableFrame
                    src={'/blocks/popovers/stacked-with-footer-actions'}
                    title={'Stacked with footer actions'}
                    path={'./src/blocks/popovers/StackedWithFooterActions/StackedWithFooterActions.js|ts'}
                />
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/popovers/WithTwoColumnGrid/WithTwoColumnGrid.js|ts'}
                />
            </Box>
        </Fluid>
    );
