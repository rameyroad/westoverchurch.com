            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to display the customer reviews for a product.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/productReviews/ReviewOverview/ReviewOverview.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/product-reviews/review-quick-overview'}
                    title={'Review quick overview'}
                    path={'./src/blocks/productReviews/ReviewQuickOverview/ReviewQuickOverview.js|ts'}
                />
            </Box>
        </Fluid>
    );
