                    ...
                    <form>
                        <Grid container spacing={2}>
                                ...
                                <Box display={'flex'} alignItems={'center'}>
                                    {[1, 2, 3, 4, 5].map((r) => (
                                        <Box
                                            key={r}
                                            component={'svg'}
                                            color={r <= currentScore ? theme.palette.primary.main : theme.palette.divider}
                                            width={28}
                                            height={28}
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 20 20"
                            ...
                            <Grid item xs={12}>
                                ...
                                <TextField label="Feedback *" variant="outlined" name={'feedback'} fullWidth multiline rows={5} />
                            </Grid>
