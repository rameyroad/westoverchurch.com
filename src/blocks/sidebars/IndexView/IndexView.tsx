            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to provide a sticky side navigation to your users while using your application.</Typography>
                    </Box>
                </Container>
                <ResizableFrame src={'/blocks/sidebars/simple'} title={'Simple'} path={'./src/blocks/sidebars/Simple/Simple.js|ts'} />
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/sidebars/WithCollapsibleMenuItems/WithCollapsibleMenuItems.js|ts'}
                />
            </Box>
        </Fluid>
    );
