            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to display data lists to your users in a clean, tabular format.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/tables/with-avatars-and-multiline-content'}
                    title={'With avatars and multiline content'}
                    path={'./src/blocks/tables/WithAvatarsAndMultilineContent/WithAvatarsAndMultilineContent.js|ts'}
                />
                <ResizableFrame
                ...
                />
                <ResizableFrame src={'/blocks/tables/simple'} title={'Simple'} path={'./src/blocks/tables/Simple/Simple.js|ts'} />
            </Box>
        </Fluid>
    );
};
