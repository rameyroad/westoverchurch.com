            ...
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 750 }} aria-label="simple table">
                    <TableHead sx={{ bgcolor: 'alternate.main' }}>
                        <TableRow>
                            <TableCell>
                                <Typography color={'text.secondary'} variant={'caption'} fontWeight={700} sx={{ textTransform: 'uppercase' }}>
                                    Name
                                </Typography>
                            </TableCell>
                            <TableCell>
                    ...
                    <TableBody>
                        {mock.map((item, i) => (
                            <TableRow key={i} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                ...
                                <TableCell>
                                    <Typography color={'primary'} variant={'subtitle2'} fontWeight={700} sx={{ cursor: 'pointer' }}>
                                        Edit
                                    </Typography>
                                </TableCell>
                            </TableRow>
