            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Standard form elements with various styles and layout options.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/formControls/StackedCustomRadioGroup/StackedCustomRadioGroup.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/form-controls/custom-radio-group'}
                    title={'Custom radio group'}
                    path={'./src/blocks/formControls/CustomRadioGroup/CustomRadioGroup.js|ts'}
                />
                <ResizableFrame
