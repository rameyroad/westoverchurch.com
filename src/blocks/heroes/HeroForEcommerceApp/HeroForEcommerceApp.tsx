                ...
                <Grid item xs={12} md={6}>
                    <Box>
                        ...
                        <Box marginBottom={3}>
                            ...
                            <Typography variant="h3" color="text.primary" sx={{ fontWeight: 700, color: colors.red[400] }}>
                                $299.95
                            </Typography>
                            <Box component={Button} variant="contained" color="primary" size="large" height={54} marginTop={2}>
                                Discover the offer
                            </Box>
                        </Box>
                        <Box paddingX={2} paddingY={1} bgcolor={'alternate.dark'} borderRadius={2}>
