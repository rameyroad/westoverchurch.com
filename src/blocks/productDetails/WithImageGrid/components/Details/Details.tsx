        ...
        <Box>
            ...
            <Box display={'flex'} alignItems={'center'} marginTop={2}>
                ...
                <Box display={'flex'} justifyContent={'flex-start'}>
                    {[1, 2, 3, 4, 5].map((item) => (
                        <Box key={item} color={item <= 4 ? 'secondary.main' : 'divider'} display={'flex'} alignItems={'center'}>
            ...
            <Box marginTop={4}>
                <Button component={Link} href={'#'} variant={'contained'} color={'primary'} size={'large'} fullWidth>
                    Add to cart
                </Button>
            </Box>
            <Box marginTop={4}>
