                ...
                <Grid item container xs={12} md={6} alignItems={'center'}>
                    <Box>
                        ...
                        <Typography variant="h6" component="p" color="text.secondary">
                            Our mission is to help you to grow your design skills, meet and connect with professional dsigners who share your
                            passions.
                        </Typography>
                        <Box marginTop={2}>
                            <Button
                        ...
                        <Grid item xs={4} key={i}>
                            <Box display={'block'} width={1} height={1}>
                                <Card>
                                    ...
                                    >
                                        <Box component={'img'} height={50} width={50} src={item.logo} alt={item.name} />
                                    </CardContent>
                                </Card>
                            </Box>
                        </Grid>
