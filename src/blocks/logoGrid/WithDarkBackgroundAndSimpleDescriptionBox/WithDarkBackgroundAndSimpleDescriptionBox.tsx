            ...
            <Container>
                <Box>
                    <Box marginBottom={4}>
                        ...
                        <Typography variant={'h6'} component={'p'} color={'text.secondary'} align={'center'} sx={{ color: 'common.white' }}>
                    ...
                    <Grid container spacing={2}>
                        {mock.map((item, i) => (
                            <Grid item xs={12} md={4} key={i}>
                                ...
                                >
                                    <Box component={Avatar} width={{ xs: 60, md: 80 }} height={{ xs: 60, md: 80 }} marginBottom={2} src={item.icon} />
