            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to display blog content in a clean and organised layout.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                    src={'/blocks/blog/vertical-minimal-designed-blog-cards'}
                    title={'Simple and minimally designed vertically aligned blog article cards'}
                    path={'./src/blocks/blog/VerticalMinimalDesignedBlogCards/VerticalMinimalDesignedBlogCards.js|ts'}
                />
                <ResizableFrame
                ...
                />
                <ResizableFrame
                    src={'/blocks/blog/vertically-aligned-blog-card-overlapped-with-description-box'}
                    title={'Vertically aligned blog cards overlapped with description box'}
                    path={
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/blog/BlogCardsWithFullBackgroundImage/BlogCardsWithFullBackgroundImage.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/blog/simple-vertical-blog-cards'}
                    title={'Simple vertically aligned blog article cards'}
                    path={'./src/blocks/blog/SimpleVerticalBlogCards/SimpleVerticalBlogCards.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/blog/horizontally-aligned-blog-card-with-shaped-image'}
                    title={'Horizontally aligned blog card with shaped image'}
                    path={'./src/blocks/blog/HorizontallyAlignedBlogCardWithShapedImage/HorizontallyAlignedBlogCardWithShapedImage.js|ts'}
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/blog/VerticallyAlignedBlogCardsWithShapedImage/VerticallyAlignedBlogCardsWithShapedImage.js|ts'}
                />
            </Box>
        </Fluid>
    );
