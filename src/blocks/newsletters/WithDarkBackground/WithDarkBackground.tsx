            ...
            <Box component={Card} boxShadow={3} paddingY={3} bgcolor={'primary.main'}>
                <CardContent>
                    <Box display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
                        <Box marginBottom={4}>
                            <Typography variant="h4" align={'center'} gutterBottom sx={{ fontWeight: 700, color: 'common.white' }}>
                                Subscribe to our newsletter
                            </Typography>
                            <Typography variant="h6" align={'center'} color={'text.secondary'} sx={{ color: 'common.white' }}>
