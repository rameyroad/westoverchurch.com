            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>A progress indicator component communicates to the user the progress of a particular process.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/progressSteps/WithNumbersOnly/WithNumbersOnly.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/progress-steps/vertical-stepper'}
                    title={'Vertical stepper'}
                    path={'./src/blocks/progressSteps/VerticalStepper/VerticalStepper.js|ts'}
                />
            </Box>
        </Fluid>
    );
