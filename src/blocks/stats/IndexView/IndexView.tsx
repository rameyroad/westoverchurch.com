        ...
        <Fluid>
            <Box bgcolor={'alternate.main'}>
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/stats/WithBorderedCardsAndBrandColor/WithBorderedCardsAndBrandColor.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/stats/with-abstract-visual-representation'}
                    title={'With abtract visual representation'}
                    path={'./src/blocks/stats/WithAbstractVisualRepresentation/WithAbstractVisualRepresentation.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/stats/client-satisfaction'}
                    title={'Client satisfaction'}
                    path={'./src/blocks/stats/ClientSatisfaction/ClientSatisfaction.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/stats/with-count-up-numbers-and-cover-image'}
                    title={'With count-up numbers and cover image'}
                    path={'./src/blocks/stats/WithCountUpNumbersAndCoverImage/WithCountUpNumbersAndCoverImage.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/stats/with-count-up-numbers-and-map'}
                    title={'With count-up numbers and map'}
                    path={'./src/blocks/stats/WithCountUpNumbersAndMap/WithCountUpNumbersAndMap.js|ts'}
                />
                <ResizableFrame
