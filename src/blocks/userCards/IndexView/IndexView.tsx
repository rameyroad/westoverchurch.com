            ...
            <Box bgcolor={'alternate.main'}>
                ...
                <Container maxWidth={1500} paddingY={'0 !important'}>
                    <Box>
                        ...
                        <Typography>Used to display information about users and contacts in your app.</Typography>
                    </Box>
                </Container>
                <ResizableFrame
                ...
                <ResizableFrame
                    ...
                    path={'./src/blocks/userCards/UserCardWithBackground/UserCardWithBackground.js|ts'}
                />
                <ResizableFrame
                    src={'/blocks/user-cards/user-card-with-rating'}
                    title={'User card with rating'}
                    path={'./src/blocks/userCards/UserCardWithRating/UserCardWithRating.js|ts'}
                />
            </Box>
        </Fluid>
    );
