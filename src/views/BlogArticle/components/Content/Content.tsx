    ...
    return (
        <Box>
            <Box paddingX={{ xs: 0, sm: 4, md: 6 }}>
                ...
                <Typography variant={'h4'} color={'primary'} align={'center'} fontWeight={'normal'}>
                    “So many teams struggle to make their onboarding experience anywhere near as good as their core product, so the results of this is
                    poor retention”
                </Typography>
                <Box marginY={4}>
            ...
            <Box marginY={4}>
                <ImageList variant="quilted" cols={3} rowHeight={isMd ? 300 : 220} gap={isMd ? 16 : 8}>
                    {photos.map((item, i) => (
            ...
            <Box component={Card} boxShadow={2} display={'flex'} flexDirection={{ xs: 'column', md: 'row-reverse' }} sx={{ backgroundImage: 'none' }}>
                <Box
                    sx={{
                        width: { xs: 1, md: '50%' },
                        position: 'relative',
                    ...
                    <form>
                        <Grid container spacing={2}>
                            <Grid item xs={12}>
                                ...
                                <Typography color={'text.secondary'}>Small heading for a smaller transition</Typography>
                            </Grid>
                            <Grid item xs={12}>
                            ...
                            <Grid item xs={12}>
                                <Button size={'large'} fullWidth variant={'contained'} type={'submit'} sx={{ height: 54 }}>
                                    Download
                                </Button>
                            </Grid>
                        </Grid>
            ...
            <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'} flexWrap={'wrap'}>
                <Box display={'flex'} alignItems={'center'}>
                    <Avatar sx={{ width: 50, height: 50, marginRight: 2 }} src={'https://assets.maccarianagency.com/avatars/img3.jpg'} />
                    <Box>
