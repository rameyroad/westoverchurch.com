                ...
                <Grid item xs={12} md={6}>
                    <Card data-aos={isMd ? 'fade-right' : 'fade-up'}>
                        <CardContent sx={{ padding: { sm: 4 } }}>
                                ...
                                <ToggleButtonGroup value={pricingOption} exclusive onChange={handleClick}>
                                    ...
                                    >
                                        <Typography
                                            ...
                                            sx={{
                                                fontWeight: 'medium',
                                                color: pricingOption === 'annual' ? theme.palette.common.white : 'primary',
                                            }}
                                        >
                                            Annual
                                        </Typography>
                                    ...
                                    <ToggleButton
                                        ...
                                        sx={{
                                            backgroundColor:
                                                pricingOption === 'monthly' ? `${theme.palette.primary.light} !important` : 'transparent',
                                            border: `1px solid ${theme.palette.primary.main}`,
                                        }}
                                    >
                                        <Typography
                            ...
                            <Box marginBottom={4}>
                                <Typography fontWeight={600} variant={'h2'} align={'center'} gutterBottom>
                ...
                <Grid item container xs={12} md={6} alignItems={'center'}>
                    <Box component={Card} bgcolor={theme.palette.primary.main}>
                        ...
                        >
                            ...
                            <Typography variant={'h4'} gutterBottom sx={{ fontWeight: 600, color: theme.palette.common.white }}>
                                Customized
                            </Typography>
