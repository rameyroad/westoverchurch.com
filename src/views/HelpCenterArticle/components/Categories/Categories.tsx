...
const Categories = (): JSX.Element => {
    ...
    const renderContent = (title, subtitle, count, icon, color) => (
        <Box display={'flex'} flexDirection={'column'} alignItems={'center'}>
            ...
            <Box paddingY={1 / 2} paddingX={1} bgcolor={'secondary.main'} borderRadius={2} marginTop={2}>
    ...
    return (
        <Box>
            <Box marginBottom={4}>
                ...
                <Box display="flex" flexDirection={{ xs: 'column', sm: 'row' }} alignItems={{ xs: 'stretched', sm: 'flex-start' }} marginTop={2}>
                    ...
                    <Grid item xs={12} md={4} key={i}>
                        ...
                        >
                            <CardContent sx={{ padding: 3 }}>
                                {renderContent(item.title, item.subtitle, item.count, item.icon, item.color)}
                            </CardContent>
                        </Card>
                    </Grid>
                ))}
