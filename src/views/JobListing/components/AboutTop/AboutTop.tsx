                ...
                <Grid item container xs={12} md={6} data-aos={isMd ? 'fade-right' : 'fade-up'} alignItems={'center'}>
                    <Box>
                        ...
                        <Typography variant={'h6'} component={'p'} color={'text.secondary'}>
                            We get thousands of job postings weekly, but only accept the openings at the top companies. We get thousands of job
                            postings weekly, but only accept the openings at the top companies.
                        </Typography>
                    </Box>
                </Grid>
