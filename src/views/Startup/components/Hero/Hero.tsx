...
const validationSchema = yup.object({
    name: yup.string().trim().min(2, 'Please enter a valid name').max(50, 'Please enter a valid name').required('Please specify your name'),
    ...
    return (
        <Box position={'relative'} zIndex={2}>
            <Box width={1} height={1} position={'absolute'} overflow={'hidden'}>
                <Box width={1} height={1} position={'absolute'} top={'50%'} left={'50%'} sx={{ transform: 'translate(-50%,-50%)' }}>
                    <iframe
                        frameBorder="0"
            ...
            >
                <Container position={'relative'} zIndex={4}>
                    <Box>
                        ...
                        <Box padding={{ xs: 3, sm: 6 }} width={1} component={Card} boxShadow={1} data-aos="fade-up">
