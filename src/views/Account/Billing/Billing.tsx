...
const validationSchema = yup.object({
    cardNumber: yup.string().test('test-number', 'Credit card number is invalid', (value) => valid.number(value).isValid),
    ...
    zip: yup.string().trim().min(2, 'Please enter a valid zip').max(8, 'Please enter a valid zip').required('Please specify the billing zip code'),
    cvv: yup
        .string()
        .trim()
            ...
            <Page>
                <Box>
                    ...
                    <Typography variant={'subtitle2'} color={'text.secondary'} gutterBottom>
                        Please be informed that we do not share any sensitive information such as your bank card data with any third party agencies
                        and companies.
                    </Typography>
